...
<!--AWS Account Management-->
  <xsl:template match="*[name()='shared' and @id='ACCTlong']" priority="1"><xsl:text>Account Management</xsl:text></xsl:template>
...
<!--AWS Activate Console-->
  <xsl:template match="*[name()='shared' and @id='ActivateConsolelong']" priority="1"><xsl:text>Activate Console</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ActivateConsole']" priority="1"><xsl:text>Activate Console</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Agent Service-->
<!--AWS Agent Service-->
  <xsl:template match="*[name()='shared' and @id='AGTSVClong']" priority="1"><xsl:text>Agent Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AGTSVC']" priority="1"><xsl:text>Agent Service</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Amplify-->
<!--Alexa Web Information Service-->
  <xsl:template match="*[name()='shared' and @id='AMPLIFYlong']" priority="1"><xsl:text>Amplify</xsl:text></xsl:template>
...
<!--AWS AppConfig-->
<!--AppConfig-->
  <xsl:template match="*[name()='shared' and @id='APPClong']" priority="1"><xsl:text>AppConfig</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='APPC']" priority="1"><xsl:text>AppConfig</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS AppConfig Data-->
<!--AWS AppConfig Data-->
  <xsl:template match="*[name()='shared' and @id='AppConfigDatalong']" priority="1"><xsl:text>AppConfig Data</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AppConfigData']" priority="1"><xsl:text>AppConfig Data</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Application Discovery Service-->
  <xsl:template match="*[name()='shared' and @id='APP-DSlong']" priority="1"><xsl:text>Application Discovery Service</xsl:text></xsl:template>
...
<!--AWS Application Migration Service-->
  <xsl:template match="*[name()='shared' and @id='MGNlong']" priority="1"><xsl:text>Application Migration Service</xsl:text></xsl:template>
...
<!--App Mesh-->
<!--AWS App Mesh-->
  <xsl:template match="*[name()='shared' and @id='MESHlong']" priority="1"><xsl:text>App Mesh</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MESH']" priority="1"><xsl:text>App Mesh</xsl:text></xsl:template>
<!--**************************************-->

<!--App Runner-->
<!--App Runner-->
  <xsl:template match="*[name()='shared' and @id='ARlong']" priority="1"><xsl:text>App Runner</xsl:text></xsl:template>
...
<!--AWS AppSync-->
<!--AWS AppSync-->
  <xsl:template match="*[name()='shared' and @id='APSYlong']" priority="1"><xsl:text>AppSync</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='APSY']" priority="1"><xsl:text>AppSync</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Artifact-->
<!--AWS Artifact-->
  <xsl:template match="*[name()='shared' and @id='ARTlong']" priority="1"><xsl:text>Artifact</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ART']" priority="1"><xsl:text>Artifact</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Audit Manager-->
<!--Audit Manager-->
  <xsl:template match="*[name()='shared' and @id='AMlong']" priority="1"><xsl:text>Audit Manager</xsl:text></xsl:template>
...
<!--AWS Auto Scaling Plans-->
  <xsl:template match="*[name()='shared' and @id='AWS-ASPlanslong']" priority="1"><xsl:text>Auto Scaling Plans</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-ASPlans']" priority="1"><xsl:text>Auto Scaling Plans</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Auto Scaling-->
<!--Auto Scaling-->
  <xsl:template match="*[name()='shared' and @id='AWS-ASlong']" priority="1"><xsl:text>Auto Scaling</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-AS']" priority="1"><xsl:text>Auto Scaling</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Backup-->
<!--AWS Backup-->
  <xsl:template match="*[name()='shared' and @id='BKPlong']" priority="1"><xsl:text>Backup</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='BKP']" priority="1"><xsl:text>Backup</xsl:text></xsl:template>
<!--**************************************-->

<!--Backup gateway-->
<!--AWS Backup gateway-->
  <xsl:template match="*[name()='shared' and @id='BGWlong']" priority="1"><xsl:text>Backup gateway</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='BGW']" priority="1"><xsl:text>Backup gateway</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Batch-->
<!--AWS Batch-->
  <xsl:template match="*[name()='shared' and @id='BATCHlong']" priority="1"><xsl:text>Batch</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='BATCH']" priority="1"><xsl:text>Batch</xsl:text></xsl:template>
<!--**************************************-->

<!--Billing and Cost Management-->
<!--AWS Billing and Cost Management-->
  <xsl:template match="*[name()='shared' and @id='ABlong']" priority="1"><xsl:text>Billing and Cost Management</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AB']" priority="1"><xsl:text>Billing and Cost Management</xsl:text></xsl:template>
<!--**************************************-->

<!--Billing Conductor-->
<!--AWS Billing Conductor-->
  <xsl:template match="*[name()='shared' and @id='ABClong']" priority="1"><xsl:text>Billing Conductor</xsl:text></xsl:template>
...
<!--AWS Cost Management Console-->
  <xsl:template match="*[name()='shared' and @id='CMConsolelong']" priority="1"><xsl:text>Cost Management Console</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CMConsole']" priority="1"><xsl:text>Cost Management Console</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Documentation-->
<!--AWS Documentation-->
  <xsl:template match="*[name()='shared' and @id='AWSDOCSlong']" priority="1"><xsl:text>Amazon Web Services Documentation</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSDOCS']" priority="1"><xsl:text>Amazon Web Services Documentation</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Management Console-->
<!--AWS Management Console-->
  <xsl:template match="*[name()='shared' and @id='consolelong']" priority="1"><xsl:text>Amazon Web Services Management Console</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='console']" priority="1"><xsl:text>Amazon Web Services Management Console</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Console Home-->
<!--AWS Console Home-->
  <xsl:template match="*[name()='shared' and @id='consolehomelong']" priority="1"><xsl:text>Amazon Web Services Console Home</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='consolehome']" priority="1"><xsl:text>Amazon Web Services Console Home</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Marketing Website-->
<!--AWS Marketing Website-->
  <xsl:template match="*[name()='shared' and @id='MarketingSitelong']" priority="1"><xsl:text>Amazon Web Services Marketing Website</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MarketingSite']" priority="1"><xsl:text>Amazon Web Services Marketing Website</xsl:text></xsl:template>
<!--**************************************-->

<!--Cost Explorer-->
<!--Cost Explorer-->
  <xsl:template match="*[name()='shared' and @id='ce-long']" priority="1"><xsl:text>Cost Explorer</xsl:text></xsl:template>
...
<!--AWS BugBust-->
<!--AWS BugBust-->
  <xsl:template match="*[name()='shared' and @id='ABBlong']" priority="1"><xsl:text>BugBust</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ABB']" priority="1"><xsl:text>BugBust</xsl:text></xsl:template>
<!--**************************************-->

<!--ACM-->
<!--AWS Certificate Manager-->
  <xsl:template match="*[name()='shared' and @id='ACMlong']" priority="1"><xsl:text>Certificate Manager</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ACM']" priority="1"><xsl:text>ACM</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Chatbot-->
<!--Chatbot-->
  <xsl:template match="*[name()='shared' and @id='CBTlong']" priority="1"><xsl:text>Chatbot</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CBT']" priority="1"><xsl:text>Chatbot</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Cloud9-->
<!--AWS Cloud9-->
  <xsl:template match="*[name()='shared' and @id='AC9long']" priority="1"><xsl:text>Cloud9</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AC9']" priority="1"><xsl:text>Cloud9</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS CDI-->
<!--Cloud Digital Interface (CDI)-->
  <xsl:template match="*[name()='shared' and @id='CDIlong']" priority="1"><xsl:text>Cloud Digital Interface</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CDI']" priority="1"><xsl:text>CDI</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS CDK-->
<!--AWS Cloud Development Kit (CDK)-->
  <xsl:template match="*[name()='shared' and @id='CDKlong']" priority="1"><xsl:text>Cloud Development Kit (CDK)</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CDK']" priority="1"><xsl:text>CDK</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Cloud Map-->
<!--AWS Cloud Map-->
  <xsl:template match="*[name()='shared' and @id='CMAPlong']" priority="1"><xsl:text>Cloud Map</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CMAP']" priority="1"><xsl:text>Cloud Map</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS CloudFormation-->
<!--CloudFormation-->
  <xsl:template match="*[name()='shared' and @id='CFNlong']" priority="1"><xsl:text>CloudFormation</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CFN']" priority="1"><xsl:text>CloudFormation</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS CloudHSM-->
<!--CloudHSM-->
  <xsl:template match="*[name()='shared' and @id='HSMlong']" priority="1"><xsl:text>CloudHSM</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='HSM']" priority="1"><xsl:text>CloudHSM</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS CloudHSM Classic-->
<!--AWS CloudHSM Classic-->
  <xsl:template match="*[name()='shared' and @id='HSMClassiclong']" priority="1"><xsl:text>CloudHSM Classic</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='HSMClassic']" priority="1"><xsl:text>CloudHSM Classic</xsl:text></xsl:template>
<!--**************************************-->
...
<!--CloudShell-->
<!--CloudShell-->
  <xsl:template match="*[name()='shared' and @id='CShell']" priority="1"><xsl:text>CloudShell</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CShellshort']" priority="1"><xsl:text>CloudShell</xsl:text></xsl:template>
<!--**************************************-->

<!--CloudTrail-->
<!--AWS CloudTrail-->
  <xsl:template match="*[name()='shared' and @id='CTlong']" priority="1"><xsl:text>CloudTrail</xsl:text></xsl:template>
...
<!--CodeArtifact-->
<!--CodeArtifact-->
  <xsl:template match="*[name()='shared' and @id='ACAlong']" priority="1"><xsl:text>CodeArtifact</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ACA']" priority="1"><xsl:text>CodeArtifact</xsl:text></xsl:template>
<!--**************************************-->

<!--CodeBuild-->
<!--AWS CodeBuild-->
  <xsl:template match="*[name()='shared' and @id='ACBlong']" priority="1"><xsl:text>CodeBuild</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ACB']" priority="1"><xsl:text>CodeBuild</xsl:text></xsl:template>
<!--**************************************-->

<!--CodeCommit-->
<!--AWS CodeCommit-->
  <xsl:template match="*[name()='shared' and @id='ACClong']" priority="1"><xsl:text>CodeCommit</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ACC']" priority="1"><xsl:text>CodeCommit</xsl:text></xsl:template>
<!--**************************************-->

<!--CodeDeploy-->
<!--AWS CodeDeploy-->
  <xsl:template match="*[name()='shared' and @id='ACDlong']" priority="1"><xsl:text>CodeDeploy</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ACD']" priority="1"><xsl:text>CodeDeploy</xsl:text></xsl:template>
<!--**************************************-->

<!--CodePipeline-->
<!--AWS CodePipeline-->
  <xsl:template match="*[name()='shared' and @id='ACPlong']" priority="1"><xsl:text>CodePipeline</xsl:text></xsl:template>
...
<!--Command Line Interface (CLI)-->
  <xsl:template match="*[name()='shared' and @id='CLIlong']" priority="1"><xsl:text>Command Line Interface</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CLI']" priority="1"><xsl:text>CLI</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Compute Optimizer-->
<!--Compute Optimizer-->
  <xsl:template match="*[name()='shared' and @id='COlong']" priority="1"><xsl:text>Compute Optimizer</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CO']" priority="1"><xsl:text>Compute Optimizer</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Config-->
<!--Config-->
  <xsl:template match="*[name()='shared' and @id='CClong']" priority="1"><xsl:text>Config</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CC']" priority="1"><xsl:text>Config</xsl:text></xsl:template>
<!--**************************************-->

<!--Cloud Control API-->
<!--AWS Cloud Control API-->
  <xsl:template match="*[name()='shared' and @id='CCAPIlong']" priority="1"><xsl:text>Cloud Control API</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CCAPI']" priority="1"><xsl:text>Cloud Control API</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Config Rules-->
<!--Config Rules-->
  <xsl:template match="*[name()='shared' and @id='CCRlong']" priority="1"><xsl:text>Config Rules</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CCR']" priority="1"><xsl:text>Config Rules</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Connector Service-->
  <xsl:template match="*[name()='shared' and @id='AWSConnectorServicelong']" priority="1"><xsl:text>Connector Service</xsl:text></xsl:template>
...
<!--Console Mobile Application-->
  <xsl:template match="*[name()='shared' and @id='CMAlong']" priority="1"><xsl:text>Console Mobile Application</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CMA']" priority="1"><xsl:text>Console Mobile Application</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Control Tower-->
<!--Control Tower-->
  <xsl:template match="*[name()='shared' and @id='CTowerlong']" priority="1"><xsl:text>Control Tower</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CTower']" priority="1"><xsl:text>Control Tower</xsl:text></xsl:template>
<!--**************************************-->

<!--Cost Explorer Service-->
<!--AWS Cost Explorer Service-->
  <xsl:template match="*[name()='shared' and @id='AWSCostExplorerServicelong']" priority="1"><xsl:text>Cost Explorer Service</xsl:text></xsl:template>
...
<!--AWS Data Exchange-->
<!--AWS Data Exchange-->
  <xsl:template match="*[name()='shared' and @id='ADElong']" priority="1"><xsl:text>Data Exchange</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ADE']" priority="1"><xsl:text>Data Exchange</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Data Pipeline-->
<!--Data Pipeline-->
  <xsl:template match="*[name()='shared' and @id='AWSDPlong']" priority="1"><xsl:text>Data Pipeline</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSDP']" priority="1"><xsl:text>Data Pipeline</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS DMS-->
<!--Database Migration Service-->
  <xsl:template match="*[name()='shared' and @id='DMSlong']" priority="1"><xsl:text>Database Migration Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='DMS']" priority="1"><xsl:text>DMS</xsl:text></xsl:template>
<!--**************************************-->

<!--DataSync-->
<!--AWS DataSync-->
  <xsl:template match="*[name()='shared' and @id='DSYlong']" priority="1"><xsl:text>DataSync</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='DSY']" priority="1"><xsl:text>DataSync</xsl:text></xsl:template>
<!--**************************************-->

<!--DLAMI-->
<!--Deep Learning AMI-->
  <xsl:template match="*[name()='shared' and @id='dlalong']" priority="1"><xsl:text>Deep Learning AMI</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='dla']" priority="1"><xsl:text>DLAMI</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS DeepLens-->
<!--AWS DeepLens-->
  <xsl:template match="*[name()='shared' and @id='DLlong']" priority="1"><xsl:text>DeepLens</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='DL']" priority="1"><xsl:text>DeepLens</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS DeepRacer-->
<!--AWS DeepRacer-->
  <xsl:template match="*[name()='shared' and @id='AWSDeepRacerlong']" priority="1"><xsl:text>DeepRacer</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSDeepRacer']" priority="1"><xsl:text>DeepRacer</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Device Farm-->
<!--AWS Device Farm-->
  <xsl:template match="*[name()='shared' and @id='ATPlong']" priority="1"><xsl:text>Device Farm</xsl:text></xsl:template>
...
<!--AWS Direct Connect-->
<!--AWS Direct Connect-->
  <xsl:template match="*[name()='shared' and @id='AWS-DC-long']" priority="1"><xsl:text>Direct Connect</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-DC']" priority="1"><xsl:text>Direct Connect</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Directory Service-->
<!--Directory Service (Galaxy)-->
  <xsl:template match="*[name()='shared' and @id='ADSlong']" priority="1"><xsl:text>Directory Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ADS']" priority="1"><xsl:text>Directory Service</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Directory Service-->
<!--Directory Service (Galaxy)-->
  <xsl:template match="*[name()='shared' and @id='GXYlong']" priority="1"><xsl:text>Directory Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GXY']" priority="1"><xsl:text>Directory Service</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Managed Microsoft AD-->
<!--Managed Microsoft AD-->
  <xsl:template match="*[name()='shared' and @id='managed-ad-long']" priority="1"><xsl:text>Directory Service for Microsoft Active Directory</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='managed-ad']" priority="1"><xsl:text>Managed Microsoft AD</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Fargate-->
<!--Fargate-->
  <xsl:template match="*[name()='shared' and @id='FARGATElong']" priority="1"><xsl:text>Fargate</xsl:text></xsl:template>
...
<!--AWS Elastic Beanstalk-->
  <xsl:template match="*[name()='shared' and @id='AEBlong']" priority="1"><xsl:text>Elastic Beanstalk</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AEB']" priority="1"><xsl:text>Elastic Beanstalk</xsl:text></xsl:template>
<!--**************************************-->

<!--Elastic Disaster Recovery-->
<!--AWS Elastic Disaster Recovery-->
  <xsl:template match="*[name()='shared' and @id='DRSlong']" priority="1"><xsl:text>Elastic Disaster Recovery</xsl:text></xsl:template>
...
<!--AWS Encryption SDK-->
<!--Encryption SDK-->
  <xsl:template match="*[name()='shared' and @id='CryptoSDKlong']" priority="1"><xsl:text>Encryption SDK</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CryptoSDK']" priority="1"><xsl:text>Encryption SDK</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Fault Injection Simulator (FIS)-->
  <xsl:template match="*[name()='shared' and @id='FISlong']" priority="1"><xsl:text>Fault Injection Simulator</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='FIS']" priority="1"><xsl:text>FIS</xsl:text></xsl:template>
<!--**************************************-->

<!--FinSpace-->
<!--Amazon FinSpace-->
  <xsl:template match="*[name()='shared' and @id='FSlong']" priority="1"><xsl:text>FinSpace</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='FS']" priority="1"><xsl:text>FinSpace</xsl:text></xsl:template>
<!--**************************************-->

<!--Firewall Manager-->
<!--AWS Firewall Manager-->
  <xsl:template match="*[name()='shared' and @id='FMSlong']" priority="1"><xsl:text>Firewall Manager</xsl:text></xsl:template>
...
<!--Flow Framework (see also "SWF")-->
  <xsl:template match="*[name()='shared' and @id='FFlong']" priority="1"><xsl:text>Flow Framework</xsl:text></xsl:template>
...
<!--Global Accelerator-->
<!--Global Accelerator-->
  <xsl:template match="*[name()='shared' and @id='GAXlong']" priority="1"><xsl:text>Global Accelerator</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GAX']" priority="1"><xsl:text>Global Accelerator</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Glue-->
<!--AWS Glue-->
  <xsl:template match="*[name()='shared' and @id='GLUlong']" priority="1"><xsl:text>Glue</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GLU']" priority="1"><xsl:text>Glue</xsl:text></xsl:template>
<!--**************************************-->

<!--AWSGlueSchemaRegistry-->
<!--AWSGlueSchemaRegistry-->
  <xsl:template match="*[name()='shared' and @id='dsrlong']" priority="1"><xsl:text>GlueSchemaRegistry</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='dsr']" priority="1"><xsl:text>GlueSchemaRegistry</xsl:text></xsl:template>
<!--**************************************-->

<!--Data Catalog-->
<!--Glue Data Catalog-->
  <xsl:template match="*[name()='shared' and @id='GLUDCLong']" priority="1"><xsl:text>Glue Data Catalog</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GLUDC']" priority="1"><xsl:text>Data Catalog</xsl:text></xsl:template>
<!--**************************************-->

<!--Jobs system-->
<!--Jobs system-->
  <xsl:template match="*[name()='shared' and @id='JESlong']" priority="1"><xsl:text>Glue Jobs system</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JES']" priority="1"><xsl:text>Jobs system</xsl:text></xsl:template>
<!--**************************************-->

<!--DataBrew-->
<!--DataBrew-->
  <xsl:template match="*[name()='shared' and @id='BRUlong']" priority="1"><xsl:text>Glue DataBrew</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='BRU']" priority="1"><xsl:text>DataBrew</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Greengrass-->
<!--AWS IoT Greengrass-->
  <xsl:template match="*[name()='shared' and @id='GGlong']" priority="1"><xsl:text>IoT Greengrass</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GG']" priority="1"><xsl:text>IoT Greengrass</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Greengrass V1-->
<!--AWS IoT Greengrass V1-->
  <xsl:template match="*[name()='shared' and @id='GG1long']" priority="1"><xsl:text>IoT Greengrass Version 1</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GG1']" priority="1"><xsl:text>IoT Greengrass V1</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Greengrass V2-->
<!--AWS IoT Greengrass V2-->
  <xsl:template match="*[name()='shared' and @id='GG2long']" priority="1"><xsl:text>IoT Greengrass Version 2</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GG2']" priority="1"><xsl:text>IoT Greengrass V2</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Ground Station-->
<!--Ground Station-->
  <xsl:template match="*[name()='shared' and @id='GRSlong']" priority="1"><xsl:text>Ground Station</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GRS']" priority="1"><xsl:text>Ground Station</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Health-->
<!--AWS Health-->
  <xsl:template match="*[name()='shared' and @id='awshealthlong']" priority="1"><xsl:text>Health</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='awshealth']" priority="1"><xsl:text>Health</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Health Dashboard-->
<!--AWS Health Dashboard-->
  <xsl:template match="*[name()='shared' and @id='phdlong']" priority="1"><xsl:text>Health Dashboard</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='phd']" priority="1"><xsl:text>Health Dashboard</xsl:text></xsl:template>
<!--**************************************-->

<!--IAM-->
<!--AWS Identity and Access Management-->
  <xsl:template match="*[name()='shared' and @id='IAMlong']" priority="1"><xsl:text>Identity and Access Management</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IAM']" priority="1"><xsl:text>IAM</xsl:text></xsl:template>
<!--**************************************-->

<!--IAM Access Analyzer-->
<!--IAM Access Analyzer-->
  <xsl:template match="*[name()='shared' and @id='iam-citadel-long']" priority="1"><xsl:text>Identity and Access Management Access Analyzer</xsl:text></xsl:template>
...
<!--AWSTOE-->
<!--AWS TOE-->
  <xsl:template match="*[name()='shared' and @id='TOElong']" priority="1"><xsl:text>Task Orchestrator and Executor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TOE']" priority="1"><xsl:text>Amazon Web Services TOE</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Import/Export-->
<!--Import/Export-->
  <xsl:template match="*[name()='shared' and @id='IElong']" priority="1"><xsl:text>Import/Export</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IE']" priority="1"><xsl:text>Import/Export</xsl:text></xsl:template>
<!--**************************************-->

<!--Disk-->
<!--AWS Import/Export Disk-->
  <xsl:template match="*[name()='shared' and @id='Disklong']" priority="1"><xsl:text>Import/Export Disk</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Disk']" priority="1"><xsl:text>Disk</xsl:text></xsl:template>
<!--**************************************-->

<!--Snowball-->
<!--AWS Snowball-->
  <xsl:template match="*[name()='shared' and @id='Frozenlong']" priority="1"><xsl:text>Snowball</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Frozen']" priority="1"><xsl:text>Snowball</xsl:text></xsl:template>
<!--**************************************-->

<!--Signer-->
<!--Signer-->
  <xsl:template match="*[name()='shared' and @id='Signerlong']" priority="1"><xsl:text>Signer</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Signer']" priority="1"><xsl:text>Signer</xsl:text></xsl:template>
<!--**************************************-->

<!--Snowball Edge-->
<!--AWS Snowball Edge-->
  <xsl:template match="*[name()='shared' and @id='SnowballEdgelong']" priority="1"><xsl:text>Snowball Edge</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SnowballEdge']" priority="1"><xsl:text>Snowball Edge</xsl:text></xsl:template>
<!--**************************************-->

<!--Snowcone-->
<!--Snowcone-->
  <xsl:template match="*[name()='shared' and @id='SNClong']" priority="1"><xsl:text>Snowcone</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SNC']" priority="1"><xsl:text>Snowcone</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS OpsHub-->
<!--OpsHub-->
  <xsl:template match="*[name()='shared' and @id='OpsHublong']" priority="1"><xsl:text>OpsHub for Snow Family</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OpsHub']" priority="1"><xsl:text>OpsHub</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS IoT-->
<!--AWS IoT-->
  <xsl:template match="*[name()='shared' and @id='IoTlong']" priority="1"><xsl:text>IoT</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoT']" priority="1"><xsl:text>IoT</xsl:text></xsl:template>
<!--**************************************-->

<!--AVS for AWS IoT-->
<!--AVS for IoT-->
  <xsl:template match="*[name()='shared' and @id='IoTAlexa']" priority="1"><xsl:text>Alexa Voice Service (AVS) Integration for IoT</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTAlexashort']" priority="1"><xsl:text>AVS for IoT</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Analytics-->
<!--AWS IoT Analytics-->
  <xsl:template match="*[name()='shared' and @id='ITAlong']" priority="1"><xsl:text>IoT Analytics</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITA']" priority="1"><xsl:text>IoT Analytics</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT data-->
<!--Amazon IoT data-->
  <xsl:template match="*[name()='shared' and @id='IoTDatalong']" priority="1"><xsl:text>IoT data</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTData']" priority="1"><xsl:text>IoT data</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Device Defender-->
<!--AWS IoT Device Defender-->
  <xsl:template match="*[name()='shared' and @id='ITDDlong']" priority="1"><xsl:text>IoT Device Defender</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITDD']" priority="1"><xsl:text>IoT Device Defender</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Device Management-->
<!--AWS IoT Device Management-->
  <xsl:template match="*[name()='shared' and @id='ITDMlong']" priority="1"><xsl:text>IoT Device Management</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITDM']" priority="1"><xsl:text>IoT Device Management</xsl:text></xsl:template>
<!--**************************************-->

<!--Fleet Hub-->
<!--Fleet Hub-->
  <xsl:template match="*[name()='shared' and @id='IoTMonitorlong']" priority="1"><xsl:text>Fleet Hub for IoT Device Management</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTMonitor']" priority="1"><xsl:text>Fleet Hub</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Events-->
<!--AWS IoT Events-->
  <xsl:template match="*[name()='shared' and @id='ITElong']" priority="1"><xsl:text>IoT Events</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITE']" priority="1"><xsl:text>IoT Events</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Events-Data-->
<!--AWS IoT Events-Data-->
  <xsl:template match="*[name()='shared' and @id='ITEDlong']" priority="1"><xsl:text>IoT Events-Data</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITED']" priority="1"><xsl:text>IoT Events-Data</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Identity-->
<!--AWS IoT Identity-->
  <xsl:template match="*[name()='shared' and @id='IoTIdentitylong']" priority="1"><xsl:text>IoT Identity</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTIdentity']" priority="1"><xsl:text>IoT Identity</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT 1-Click-->
<!--AWS IoT 1-Click-->
  <xsl:template match="*[name()='shared' and @id='ITOClong']" priority="1"><xsl:text>IoT 1-Click</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITOC']" priority="1"><xsl:text>IoT 1-Click</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Jobs SDK release-->
<!--AWS IoT Jobs SDK release-->
  <xsl:template match="*[name()='shared' and @id='IoTJobsSDKreleaselong']" priority="1"><xsl:text>IoT Jobs SDK release</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTJobsSDKrelease']" priority="1"><xsl:text>IoT Jobs SDK release</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Secure Tunneling-->
<!--AWS IoT Secure Tunneling-->
  <xsl:template match="*[name()='shared' and @id='IoTSecureTunnellong']" priority="1"><xsl:text>IoT Secure Tunneling</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTSecureTunnel']" priority="1"><xsl:text>IoT Secure Tunneling</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT SiteWise-->
<!--AWS IoT SiteWise-->
  <xsl:template match="*[name()='shared' and @id='ITSWlong']" priority="1"><xsl:text>IoT SiteWise</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITSW']" priority="1"><xsl:text>IoT SiteWise</xsl:text></xsl:template>
<!--**************************************-->

<!--SiteWise Monitor-->
<!--AWS IoT SiteWise Monitor-->
  <xsl:template match="*[name()='shared' and @id='ITSWMlong']" priority="1"><xsl:text>IoT SiteWise Monitor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITSWM']" priority="1"><xsl:text>SiteWise Monitor</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT Things Graph-->
<!--AWS IoT Things Graph-->
  <xsl:template match="*[name()='shared' and @id='ITTGlong']" priority="1"><xsl:text>IoT Things Graph</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITTG']" priority="1"><xsl:text>IoT Things Graph</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS IoT TwinMaker-->
<!--AWS IoT TwinMaker-->
  <xsl:template match="*[name()='shared' and @id='IoTTMlong']" priority="1"><xsl:text>IoT TwinMaker</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTTM']" priority="1"><xsl:text>IoT TwinMaker</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Key Management Service-->
  <xsl:template match="*[name()='shared' and @id='KMSlong']" priority="1"><xsl:text>Key Management Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='KMS']" priority="1"><xsl:text>KMS</xsl:text></xsl:template>
<!--**************************************-->

<!--KMS key-->
<!--KMS key-->
  <xsl:template match="*[name()='shared' and @id='kms-key-long']" priority="1"><xsl:text>KMS key</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='kms-key']" priority="1"><xsl:text>KMS key</xsl:text></xsl:template>
<!--**************************************-->

<!--KMS keys-->
<!--KMS keys-->
  <xsl:template match="*[name()='shared' and @id='kms-keys-long']" priority="1"><xsl:text>KMS keys</xsl:text></xsl:template>
...
<!--Incident Manager-->
<!--Incident Manager-->
  <xsl:template match="*[name()='shared' and @id='commander-long']" priority="1"><xsl:text>Systems Manager Incident Manager</xsl:text></xsl:template>
...
<!--Lake Formation-->
<!--Lake Formation-->
  <xsl:template match="*[name()='shared' and @id='LFlong']" priority="1"><xsl:text>Lake Formation</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='LF']" priority="1"><xsl:text>Lake Formation</xsl:text></xsl:template>
<!--**************************************-->

<!--Lambda-->
<!--AWS Lambda-->
  <xsl:template match="*[name()='shared' and @id='LAMlong']" priority="1"><xsl:text>Lambda</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='LAM']" priority="1"><xsl:text>Lambda</xsl:text></xsl:template>
<!--**************************************-->

<!--Lambda console-->
<!--AWS Lambda console-->
  <xsl:template match="*[name()='shared' and @id='LAMConsolelong']" priority="1"><xsl:text>Lambda console</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='LAMConsole']" priority="1"><xsl:text>Lambda console</xsl:text></xsl:template>
<!--**************************************-->

<!--Launch Wizard-->
<!--Launch Wizard-->
  <xsl:template match="*[name()='shared' and @id='LWlong']" priority="1"><xsl:text>Launch Wizard</xsl:text></xsl:template>
...
<!--License Manager-->
<!--AWS License Manager-->
  <xsl:template match="*[name()='shared' and @id='LIClong']" priority="1"><xsl:text>License Manager</xsl:text></xsl:template>
...
<!--AWS License Manager master account SLR-->
  <xsl:template match="*[name()='shared' and @id='LICMasterAcctSlrlong']" priority="1"><xsl:text>License Manager master account SLR</xsl:text></xsl:template>
...
<!--AWS License Manager member account SLR-->
  <xsl:template match="*[name()='shared' and @id='LICMemberAcctSlrlong']" priority="1"><xsl:text>License Manager member account SLR</xsl:text></xsl:template>
...
<!--AMS-->
<!--AMS-->
  <xsl:template match="*[name()='shared' and @id='AMSlong']" priority="1"><xsl:text>Managed Services</xsl:text></xsl:template>
...
<!--management portal-->
<!--management portal-->
  <xsl:template match="*[name()='shared' and @id='AMPlong']" priority="1"><xsl:text>Management Portal for vCenter</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AMP']" priority="1"><xsl:text>management portal</xsl:text></xsl:template>
<!--**************************************-->

<!--connector-->
<!--connector-->
  <xsl:template match="*[name()='shared' and @id='AMPClong']" priority="1"><xsl:text>Connector for vCenter</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AMPC']" priority="1"><xsl:text>connector</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Marketplace Catalog API-->
<!--AWS Marketplace Catalog API-->
  <xsl:template match="*[name()='shared' and @id='MKTCAPIlong']" priority="1"><xsl:text>Marketplace Catalog API</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MKTCAPI']" priority="1"><xsl:text>Marketplace Catalog API</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Marketplace Commerce Analytics-->
<!--AWS Marketplace Commerce Analytics-->
  <xsl:template match="*[name()='shared' and @id='MKTCAlong']" priority="1"><xsl:text>Marketplace Commerce Analytics</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MKTCA']" priority="1"><xsl:text>Marketplace Commerce Analytics</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Marketplace Entitlement Service-->
<!--AWS Marketplace Entitlement Service-->
  <xsl:template match="*[name()='shared' and @id='MKTESlong']" priority="1"><xsl:text>Marketplace Entitlement Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MKTES']" priority="1"><xsl:text>Marketplace Entitlement Service</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Marketplace Metering Service-->
<!--AWS Marketplace Metering Service-->
  <xsl:template match="*[name()='shared' and @id='MKTMSlong']" priority="1"><xsl:text>Marketplace Metering Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MKTMS']" priority="1"><xsl:text>Marketplace Metering Service</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Migration Hub-->
<!--AWS Migration Hub-->
  <xsl:template match="*[name()='shared' and @id='MHBlong']" priority="1"><xsl:text>Migration Hub</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MHB']" priority="1"><xsl:text>Migration Hub</xsl:text></xsl:template>
<!--**************************************-->

<!--Refactor Spaces-->
<!--AWS Migration Hub Refactor Spaces-->
  <xsl:template match="*[name()='shared' and @id='MHBRefactorlong']" priority="1"><xsl:text>Migration Hub Refactor Spaces</xsl:text></xsl:template>
...
<!--Mobile Hub-->
<!--Mobile Hub-->
  <xsl:template match="*[name()='shared' and @id='AMHlong']" priority="1"><xsl:text>Mobile Hub</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AMH']" priority="1"><xsl:text>Mobile Hub</xsl:text></xsl:template>
<!--**************************************-->

<!--Molecular Modeling-->
<!--Molecular Modeling-->
  <xsl:template match="*[name()='shared' and @id='MMlong']" priority="1"><xsl:text>Molecular Modeling</xsl:text></xsl:template>
...
<!--Network Firewall-->
<!--Network Firewall-->
  <xsl:template match="*[name()='shared' and @id='NWFWlong']" priority="1"><xsl:text>Network Firewall</xsl:text></xsl:template>
...
<!--AWS OpsWorks-->
<!--AWS OpsWorks-->
  <xsl:template match="*[name()='shared' and @id='OPSlong']" priority="1"><xsl:text>OpsWorks</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OPS']" priority="1"><xsl:text>OpsWorks</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS OpsWorks for Chef Automate-->
<!--OpsWorks for Chef Automate-->
  <xsl:template match="*[name()='shared' and @id='OPSCAlong']" priority="1"><xsl:text>OpsWorks for Chef Automate</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OPSCA']" priority="1"><xsl:text>OpsWorks for Chef Automate</xsl:text></xsl:template>
<!--**************************************-->

<!--OpsWorks for Puppet Enterprise-->
<!--OpsWorks for Puppet Enterprise-->
  <xsl:template match="*[name()='shared' and @id='OPSPUPlong']" priority="1"><xsl:text>OpsWorks for Puppet Enterprise</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OPSPUP']" priority="1"><xsl:text>OpsWorks for Puppet Enterprise</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS OpsWorks CM-->
<!--AWS OpsWorks CM-->
  <xsl:template match="*[name()='shared' and @id='OPSCMlong']" priority="1"><xsl:text>OpsWorks CM</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OPSCM']" priority="1"><xsl:text>OpsWorks CM</xsl:text></xsl:template>
<!--**************************************-->

<!--Organizations-->
<!--AWS Organizations-->
  <xsl:template match="*[name()='shared' and @id='AOlong']" priority="1"><xsl:text>Organizations</xsl:text></xsl:template>
...
<!--AWSOrigamiServiceGateway-->
  <xsl:template match="*[name()='shared' and @id='OSGlong']" priority="1"><xsl:text>OrigamiServiceGateway</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OSG']" priority="1"><xsl:text>OrigamiServiceGateway</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Outposts-->
<!--Outposts-->
  <xsl:template match="*[name()='shared' and @id='OUTlong']" priority="1"><xsl:text>Outposts</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='OUT']" priority="1"><xsl:text>Outposts</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Panorama-->
<!--Panorama-->
  <xsl:template match="*[name()='shared' and @id='PANlong']" priority="1"><xsl:text>Panorama</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PAN']" priority="1"><xsl:text>Panorama</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS ParallelCluster-->
<!--ParallelCluster-->
  <xsl:template match="*[name()='shared' and @id='parallelclusterlong']" priority="1"><xsl:text>ParallelCluster</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='parallelcluster']" priority="1"><xsl:text>ParallelCluster</xsl:text></xsl:template>
<!--**************************************-->

<!--AWSPaymentsGatewayService-->
<!--AWSPaymentsGatewayService-->
  <xsl:template match="*[name()='shared' and @id='PMNTGatewaylong']" priority="1"><xsl:text>PaymentsGatewayService</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PMNTGateway']" priority="1"><xsl:text>PaymentsGatewayService</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Partner-->
<!--Partner Network-->
  <xsl:template match="*[name()='shared' and @id='APNlong']" priority="1"><xsl:text>Partner Network</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='APN']" priority="1"><xsl:text>Partner</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Certificate Manager Private Certificate Authority-->
  <xsl:template match="*[name()='shared' and @id='PCAlong']" priority="1"><xsl:text>Certificate Manager Private Certificate Authority</xsl:text></xsl:template>
...
<!--Pricing Calculator-->
  <xsl:template match="*[name()='shared' and @id='APClong']" priority="1"><xsl:text>Pricing Calculator</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='APC']" priority="1"><xsl:text>Pricing Calculator</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Proton-->
<!--Proton-->
  <xsl:template match="*[name()='shared' and @id='ARWlong']" priority="1"><xsl:text>Proton</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ARW']" priority="1"><xsl:text>Proton</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Resource Access Manager-->
  <xsl:template match="*[name()='shared' and @id='RAMlong']" priority="1"><xsl:text>Resource Access Manager</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='RAM']" priority="1"><xsl:text>RAM</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Resilience Hub-->
<!--AWS Resilience Hub-->
  <xsl:template match="*[name()='shared' and @id='ARHlong']" priority="1"><xsl:text>Resilience Hub</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ARH']" priority="1"><xsl:text>Resilience Hub</xsl:text></xsl:template>
<!--**************************************-->

<!--Resource Groups-->
<!--Resource Groups-->
  <xsl:template match="*[name()='shared' and @id='ARGlong']" priority="1"><xsl:text>Resource Groups</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ARG']" priority="1"><xsl:text>Resource Groups</xsl:text></xsl:template>
<!--**************************************-->

<!--Resource Groups Tagging API-->
<!--AWS Resource Groups-->
  <xsl:template match="*[name()='shared' and @id='ARGTAPIlong']" priority="1"><xsl:text>Resource Groups Tagging API</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ARGTAPI']" priority="1"><xsl:text>Resource Groups Tagging API</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS RoboMaker-->
<!--AWS RoboMaker-->
  <xsl:template match="*[name()='shared' and @id='RBMlong']" priority="1"><xsl:text>RoboMaker</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='RBM']" priority="1"><xsl:text>RoboMaker</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Amazon Route 53 Public Data Plane-->
  <xsl:template match="*[name()='shared' and @id='R53PDPlong']" priority="1"><xsl:text>Route 53 Public Data Plane</xsl:text></xsl:template>
...
<!--Amazon Route 53 AWS Integration-->
  <xsl:template match="*[name()='shared' and @id='R53AWSIntlong']" priority="1"><xsl:text>Route 53 Amazon Web Services Integration</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='R53AWSInt']" priority="1"><xsl:text>Route 53 Amazon Web Services Integration</xsl:text></xsl:template>
<!--**************************************-->

<!--Route 53 Private DNS for VPCs-->
<!--Amazon Route 53 Private DNS for VPCs-->
  <xsl:template match="*[name()='shared' and @id='R53PDNSVPClong']" priority="1"><xsl:text>Route 53 Private DNS for VPCs</xsl:text></xsl:template>
...
<!--Amazon Route 53 domain registration-->
  <xsl:template match="*[name()='shared' and @id='R53DRlong']" priority="1"><xsl:text>Route 53 domain registration</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='R53DR']" priority="1"><xsl:text>Route 53 domain registration</xsl:text></xsl:template>
<!--**************************************-->

<!--Route 53 Resolver-->
<!--Amazon Route 53 Resolver-->
  <xsl:template match="*[name()='shared' and @id='R53Rlong']" priority="1"><xsl:text>Route 53 Resolver</xsl:text></xsl:template>
...
<!--Schema Conversion Tool-->
  <xsl:template match="*[name()='shared' and @id='AWSSCTlong']" priority="1"><xsl:text>Schema Conversion Tool</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSSCT']" priority="1"><xsl:text>SCT</xsl:text></xsl:template>
<!--**************************************-->

<!--Mobile SDK for Android-->
<!--Mobile SDK for Android-->
  <xsl:template match="*[name()='shared' and @id='Androidlong']" priority="1"><xsl:text>Mobile SDK for Android</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Android']" priority="1"><xsl:text>Mobile SDK for Android</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for C++-->
<!--SDK for C++-->
  <xsl:template match="*[name()='shared' and @id='CPPlong']" priority="1"><xsl:text>SDK for C++</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CPP']" priority="1"><xsl:text>SDK for C++</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Go-->
<!--SDK for Go-->
  <xsl:template match="*[name()='shared' and @id='Golong']" priority="1"><xsl:text>SDK for Go</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Go']" priority="1"><xsl:text>SDK for Go</xsl:text></xsl:template>
<!--**************************************-->

<!--Mobile SDK for iOS-->
<!--Mobile SDK for iOS-->
  <xsl:template match="*[name()='shared' and @id='iOSlong']" priority="1"><xsl:text>Mobile SDK for iOS</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='iOS']" priority="1"><xsl:text>Mobile SDK for iOS</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Java-->
<!--SDK for Java-->
  <xsl:template match="*[name()='shared' and @id='Javalong']" priority="1"><xsl:text>SDK for Java</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Java']" priority="1"><xsl:text>SDK for Java</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Java 2.x-->
<!--SDK for Java 2.x-->
  <xsl:template match="*[name()='shared' and @id='JavaV2long']" priority="1"><xsl:text>SDK for Java 2.x</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JavaV2']" priority="1"><xsl:text>SDK for Java 2.x</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for JavaScript-->
<!--SDK for JavaScript-->
  <xsl:template match="*[name()='shared' and @id='JSBlong']" priority="1"><xsl:text>SDK for JavaScript</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JSB']" priority="1"><xsl:text>SDK for JavaScript</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK Metrics-->
<!--SDK Metrics-->
  <xsl:template match="*[name()='shared' and @id='SDKMlong']" priority="1"><xsl:text>SDK Metrics for Enterprise Support</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SDKM']" priority="1"><xsl:text>SDK Metrics</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS SDK for .NET-->
<!--SDK for .NET-->
  <xsl:template match="*[name()='shared' and @id='NETlong']" priority="1"><xsl:text>SDK for .NET</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='NET']" priority="1"><xsl:text>SDK for .NET</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for PHP-->
<!--SDK for PHP-->
  <xsl:template match="*[name()='shared' and @id='PHPlong']" priority="1"><xsl:text>SDK for PHP</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PHP']" priority="1"><xsl:text>SDK for PHP</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for PHP-->
<!--SDK for PHP 2-->
  <xsl:template match="*[name()='shared' and @id='PHP2long']" priority="1"><xsl:text>SDK for PHP</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PHP2']" priority="1"><xsl:text>SDK for PHP</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Python-->
<!--SDK for Python-->
  <xsl:template match="*[name()='shared' and @id='Pythonlong']" priority="1"><xsl:text>SDK for Python (Boto)</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Python']" priority="1"><xsl:text>SDK for Python</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Python (Boto3)-->
<!--SDK for Python (Boto3)-->
  <xsl:template match="*[name()='shared' and @id='Python3long']" priority="1"><xsl:text>SDK for Python (Boto3)</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Python3']" priority="1"><xsl:text>SDK for Python (Boto3)</xsl:text></xsl:template>
<!--**************************************-->

<!--SDK for Ruby-->
<!--SDK for Ruby-->
  <xsl:template match="*[name()='shared' and @id='Rubylong']" priority="1"><xsl:text>SDK for Ruby</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Ruby']" priority="1"><xsl:text>SDK for Ruby</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS SMS-->
<!--AWS Server Migration Service-->
  <xsl:template match="*[name()='shared' and @id='SMSlong']" priority="1"><xsl:text>Server Migration Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SMS']" priority="1"><xsl:text>Server Migration Service</xsl:text></xsl:template>
<!--**************************************-->

<!--Secrets Manager-->
<!--AWS Secrets Manager-->
  <xsl:template match="*[name()='shared' and @id='ASMlong']" priority="1"><xsl:text>Secrets Manager</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ASM']" priority="1"><xsl:text>Secrets Manager</xsl:text></xsl:template>
<!--**************************************-->

<!--Security Hub-->
<!--AWS Security Hub-->
  <xsl:template match="*[name()='shared' and @id='ASHlong']" priority="1"><xsl:text>Security Hub</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ASH']" priority="1"><xsl:text>Security Hub</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS SAM-->
<!--Serverless Application Model-->
  <xsl:template match="*[name()='shared' and @id='SAMlong']" priority="1"><xsl:text>Serverless Application Model</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SAM']" priority="1"><xsl:text>SAM</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Serverless Application Repository-->
<!--AWS Serverless Application Repository-->
  <xsl:template match="*[name()='shared' and @id='SARlong']" priority="1"><xsl:text>Serverless Application Repository</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SAR']" priority="1"><xsl:text>Serverless Application Repository</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS Service Catalog-->
<!--AWS Service Catalog-->
  <xsl:template match="*[name()='shared' and @id='SClong']" priority="1"><xsl:text>Service Catalog</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SC']" priority="1"><xsl:text>Service Catalog</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Service Catalog AppRegistry-->
<!--AWS Service Catalog AppRegistry-->
  <xsl:template match="*[name()='shared' and @id='SCARlong']" priority="1"><xsl:text>Service Catalog App Registry</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SCAR']" priority="1"><xsl:text>Service Catalog AppRegistry</xsl:text></xsl:template>
<!--**************************************-->
...
<!--AWS SFTP-->
<!--SFTP-->
  <xsl:template match="*[name()='shared' and @id='SFTPlong']" priority="1"><xsl:text>Transfer for SFTP</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SFTP']" priority="1"><xsl:text>SFTP</xsl:text></xsl:template>
<!--**************************************-->

<!--Shield-->
<!--AWS Shield-->
  <xsl:template match="*[name()='shared' and @id='SHDlong']" priority="1"><xsl:text>Shield</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SHD']" priority="1"><xsl:text>Shield</xsl:text></xsl:template>
<!--**************************************-->

<!--Shield Standard-->
<!--Shield Standard-->
  <xsl:template match="*[name()='shared' and @id='SHDSTDlong']" priority="1"><xsl:text>Shield Standard</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SHDSTD']" priority="1"><xsl:text>Shield Standard</xsl:text></xsl:template>
<!--**************************************-->

<!--Shield Advanced-->
<!--Shield Advanced-->
  <xsl:template match="*[name()='shared' and @id='SHDADVlong']" priority="1"><xsl:text>Shield Advanced</xsl:text></xsl:template>
...
<!--AWS SSO-->
<!--Single Sign-On-->
  <xsl:template match="*[name()='shared' and @id='SSOlong']" priority="1"><xsl:text>Amazon Web Services Single Sign On</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SSO']" priority="1"><xsl:text>Amazon Web Services SSO</xsl:text></xsl:template>
<!--**************************************-->

<!--Snow Device Management-->
<!--AWS Snow Device Management-->
  <xsl:template match="*[name()='shared' and @id='SDMlong']" priority="1"><xsl:text>Snow Device Management</xsl:text></xsl:template>
...
<!--Systems Manager-->
<!--EC2 Systems Manager-->
  <xsl:template match="*[name()='shared' and @id='SYSlong']" priority="1"><xsl:text>Amazon Web Services Systems Manager</xsl:text></xsl:template>
...
<!--AWS Systems Manager Explorer-->
  <xsl:template match="*[name()='shared' and @id='SYSElong']" priority="1"><xsl:text>Systems Manager Explorer</xsl:text></xsl:template>
...
<!--Step Functions-->
<!--AWS Step Functions-->
  <xsl:template match="*[name()='shared' and @id='SFNlong']" priority="1"><xsl:text>Step Functions</xsl:text></xsl:template>
...
<!--AWS Step Functions - Sync Express-->
  <xsl:template match="*[name()='shared' and @id='SFNSElong']" priority="1"><xsl:text>Step Functions - Sync Express</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SFNSE']" priority="1"><xsl:text>Step Functions - Sync Express</xsl:text></xsl:template>
<!--**************************************-->

<!--Storage Gateway-->
<!--AWS Storage Gateway-->
  <xsl:template match="*[name()='shared' and @id='AWSSGlong']" priority="1"><xsl:text>Storage Gateway</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSSG']" priority="1"><xsl:text>Storage Gateway</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS STS-->
<!--AWS Security Token Service-->
  <xsl:template match="*[name()='shared' and @id='STSlong']" priority="1"><xsl:text>Security Token Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='STS']" priority="1"><xsl:text>STS</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS Support-->
<!--AWS Support-->
  <xsl:template match="*[name()='shared' and @id='SUPlong']" priority="1"><xsl:text>Amazon Web Services Support</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SUP']" priority="1"><xsl:text>Amazon Web Services Support</xsl:text></xsl:template>
<!--**************************************-->

<!--Support Center Console-->
<!--AWS Support Center Console-->
  <xsl:template match="*[name()='shared' and @id='SUPCtrConsolelong']" priority="1"><xsl:text>Support Center Console</xsl:text></xsl:template>
...
<!--Toolkit for Eclipse-->
<!--Toolkit for Eclipse-->
  <xsl:template match="*[name()='shared' and @id='TElong']" priority="1"><xsl:text>Toolkit for Eclipse</xsl:text></xsl:template>
...
<!--Toolkit for JetBrains-->
  <xsl:template match="*[name()='shared' and @id='JBIDEToolkitlong']" priority="1"><xsl:text>Toolkit for JetBrains</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JBIDEToolkit']" priority="1"><xsl:text>Toolkit for JetBrains</xsl:text></xsl:template>
<!--**************************************-->

<!--Toolkit for Visual Studio-->
<!--Toolkit for Visual Studio-->
  <xsl:template match="*[name()='shared' and @id='TVSlong']" priority="1"><xsl:text>Toolkit for Visual Studio</xsl:text></xsl:template>
...
<!--Toolkit for VS Code-->
<!--Toolkit for VS Code-->
  <xsl:template match="*[name()='shared' and @id='VSCIDEToolkit']" priority="1"><xsl:text>Toolkit for Visual Studio Code</xsl:text></xsl:template>
...
<!--Toolkit for Azure DevOps-->
  <xsl:template match="*[name()='shared' and @id='TTSlong']" priority="1"><xsl:text>Toolkit for Microsoft Azure DevOps</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TTS']" priority="1"><xsl:text>Toolkit for Azure DevOps</xsl:text></xsl:template>
<!--**************************************-->

<!--Tools for Windows PowerShell-->
<!--Tools for Windows PowerShell-->
  <xsl:template match="*[name()='shared' and @id='TWPlong']" priority="1"><xsl:text>Tools for Windows PowerShell</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TWP']" priority="1"><xsl:text>Tools for Windows PowerShell</xsl:text></xsl:template>
<!--**************************************-->

<!--Tools for PowerShell-->
<!--Tools for PowerShell-->
  <xsl:template match="*[name()='shared' and @id='TWPALLlong']" priority="1"><xsl:text>Tools for PowerShell</xsl:text></xsl:template>
...
<!--Tools for PowerShell Core-->
  <xsl:template match="*[name()='shared' and @id='TPClong']" priority="1"><xsl:text>Tools for PowerShell Core</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TPC']" priority="1"><xsl:text>Tools for PowerShell Core</xsl:text></xsl:template>
<!--**************************************-->

<!--Transfer Family-->
<!--AWS Transfer Family-->
  <xsl:template match="*[name()='shared' and @id='TFlong']" priority="1"><xsl:text>Transfer Family</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TF']" priority="1"><xsl:text>Transfer Family</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS FTP-->
<!--Transfer for FTP-->
  <xsl:template match="*[name()='shared' and @id='FTPlong']" priority="1"><xsl:text>Transfer for FTP</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='FTP']" priority="1"><xsl:text>FTP</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS FTPS-->
<!--Transfer for FTPS-->
  <xsl:template match="*[name()='shared' and @id='FTPSlong']" priority="1"><xsl:text>Transfer for FTPS</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='FTPS']" priority="1"><xsl:text>FTPS</xsl:text></xsl:template>
<!--**************************************-->
...
<!--Trusted Advisor-->
<!--AWS Trusted Advisor-->
  <xsl:template match="*[name()='shared' and @id='AWS-TA-long']" priority="1"><xsl:text>Trusted Advisor</xsl:text></xsl:template>
...
<!--Transit Gateway-->
<!--AWS Transit Gateway-->
  <xsl:template match="*[name()='shared' and @id='AWSTGlong']" priority="1"><xsl:text>Transit Gateway</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSTG']" priority="1"><xsl:text>Transit Gateway</xsl:text></xsl:template>
<!--**************************************-->

<!--Client VPN-->
<!--AWS Client VPN-->
  <xsl:template match="*[name()='shared' and @id='CVPNlong']" priority="1"><xsl:text>Client VPN</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CVPN']" priority="1"><xsl:text>Client VPN</xsl:text></xsl:template>
<!--**************************************-->

<!--Site-to-Site VPN-->
<!--Site-to-Site VPN-->
  <xsl:template match="*[name()='shared' and @id='S2Slong']" priority="1"><xsl:text>Site-to-Site VPN</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='S2S']" priority="1"><xsl:text>Site-to-Site VPN</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS VPN-->
<!--AWS Virtual Private Network-->
  <xsl:template match="*[name()='shared' and @id='VPNlong']" priority="1"><xsl:text>Virtual Private Network</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='VPN']" priority="1"><xsl:text>VPN</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS WAF-->
<!--AWS WAF-->
  <xsl:template match="*[name()='shared' and @id='WAFlong']" priority="1"><xsl:text>WAF</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAF']" priority="1"><xsl:text>WAF</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS WAFV2-->
<!--AWS WAFV2-->
  <xsl:template match="*[name()='shared' and @id='WAFv2long']" priority="1"><xsl:text>WAF</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAFv2']" priority="1"><xsl:text>WAFV2</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS WAF-->
<!--AWS WAF-->
  <xsl:template match="*[name()='shared' and @id='WAFRegionallong']" priority="1"><xsl:text>WAF</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAFRegional']" priority="1"><xsl:text>WAF</xsl:text></xsl:template>
<!--**************************************-->

<!--Wavelength-->
<!--Wavelength-->
  <xsl:template match="*[name()='shared' and @id='WAVElong']" priority="1"><xsl:text>Wavelength</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAVE']" priority="1"><xsl:text>Wavelength</xsl:text></xsl:template>
<!--**************************************-->

<!--AWS WA Tool-->
<!--Well-Architected Tool-->
  <xsl:template match="*[name()='shared' and @id='WATlong']" priority="1"><xsl:text>Well-Architected Tool</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAT']" priority="1"><xsl:text>WA Tool</xsl:text></xsl:template>
<!--**************************************-->
...
<!--X-Ray-->
<!--AWS X-Ray-->
  <xsl:template match="*[name()='shared' and @id='xraylong']" priority="1"><xsl:text>X-Ray</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='xray']" priority="1"><xsl:text>X-Ray</xsl:text></xsl:template>
<!--**************************************-->

<!--Zelkova Service-->
<!--AWS Zelkova Service-->
  <xsl:template match="*[name()='shared' and @id='zelkovalong']" priority="1"><xsl:text>Zelkova Service</xsl:text></xsl:template>
...
<!--**************************************-->
  ...
  <xsl:template match="*[name()='shared' and @id='AMR']" priority="1"><xsl:text>Amazon Web Services Managed Rules</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AMRrg']" priority="1"><xsl:text>Amazon Web Services Managed Rules rule group</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AMRrgs']" priority="1"><xsl:text>Amazon Web Services Managed Rules rule groups</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='AWS']" priority="1"><xsl:text>Amazon Web Services</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-always']" priority="1"><xsl:text>Amazon Web Services</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWSlong']" priority="1"><xsl:text>Amazon Web Services</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-account']" priority="1"><xsl:text>Amazon Web Services account</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-accounts']" priority="1"><xsl:text>Amazon Web Services accounts</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-Cloud']" priority="1"><xsl:text>Amazon Web Services Cloud</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-DC-Long']" priority="1"><xsl:text>Direct Connect</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-DClong']" priority="1"><xsl:text>Direct Connect</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='aws-managed-key']" priority="1"><xsl:text>Amazon Web Services managed key</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='aws-managed-keys']" priority="1"><xsl:text>Amazon Web Services managed keys</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='aws-owned-key']" priority="1"><xsl:text>Amazon Web Services owned key</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='aws-owned-keys']" priority="1"><xsl:text>Amazon Web Services owned keys</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-Region']" priority="1"><xsl:text>Amazon Web Services Region</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-Regions']" priority="1"><xsl:text>Amazon Web Services Regions</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-service']" priority="1"><xsl:text>Amazon Web Service</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-services']" priority="1"><xsl:text>Amazon Web Services</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-TA-Long']" priority="1"><xsl:text>Trusted Advisor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='AWS-Training']" priority="1"><xsl:text>Amazon Web Services Training</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Billinglong']" priority="1"><xsl:text>Billing</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Billing']" priority="1"><xsl:text>Billing</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Budgetslong']" priority="1"><xsl:text>Amazon Web Services Budgets</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='CFNGUARDlong']" priority="1"><xsl:text>CloudFormation Guard</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='Cluster']" priority="1"><xsl:text>Cluster</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CMG']" priority="1"><xsl:text>Cost Management</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='CryptoSDKC']" priority="1"><xsl:text>Amazon Web Services Encryption SDK for C</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CryptoSDKJava']" priority="1"><xsl:text>Amazon Web Services Encryption SDK for Java</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CryptoSDKJS']" priority="1"><xsl:text>Amazon Web Services Encryption SDK for JavaScript</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CryptoSDKPy']" priority="1"><xsl:text>Amazon Web Services Encryption SDK for Python</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CSC']" priority="1"><xsl:text>AWS CodeStar connections</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='CURlong']" priority="1"><xsl:text>Amazon Web Services Cost and Usage Report</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='FARGATEfirst']" priority="1"><xsl:text>Fargate (Fargate)</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='GLUAPI']" priority="1"><xsl:text>Amazon Web Services Glue API</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='govcloud-us']" priority="1"><xsl:text>Amazon Web Services GovCloud (US)</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='govcloud-us-region']" priority="1"><xsl:text>Amazon Web Services GovCloud (US) Region</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='GSG']" priority="1"><xsl:text>Getting Started with Amazon Web Services</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IntellijIDE']" priority="1"><xsl:text>IntelliJ IDE</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='iot-lorawan']" priority="1"><xsl:text>Amazon Web Services IoT Core for LoRaWAN</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='iot-wireless-api']" priority="1"><xsl:text>IoT Wireless</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTAYSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for Arduino Yún</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTC']" priority="1"><xsl:text>Amazon Web Services IOT Device SDK for C</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTCEmbeddedSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for Embedded C</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTCore']" priority="1"><xsl:text>Amazon Web Services IoT Core</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTCPPSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for C++</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTDA']" priority="1"><xsl:text>Device Advisor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTDAlong']" priority="1"><xsl:text>Amazon Web Services IoT Core Device Advisor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTDD']" priority="1"><xsl:text>Amazon Web Services IoT Device Defender</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTDSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTDT']" priority="1"><xsl:text>Amazon Web Services IoT Device Tester</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTFH']" priority="1"><xsl:text>IoT Fleet Hub</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTJavaSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for Java</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTJobsData']" priority="1"><xsl:text>IoT jobs data</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTJS']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for JavaScript</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTJSSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for JavaScript</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='IoTPythonSDK']" priority="1"><xsl:text>Amazon Web Services IoT Device SDK for Python</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITE-data']" priority="1"><xsl:text>IoT Events Data</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITTG-data-model']" priority="1"><xsl:text>IoT Things Graph Data Model</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITTGconsole']" priority="1"><xsl:text>IoT Things Graph console</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITTGmapdes']" priority="1"><xsl:text>IoT Things Graph mapping designer</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='ITTGmodel']" priority="1"><xsl:text>IoT Things Graph model editor</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JBIDE']" priority="1"><xsl:text>JetBrains</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JBIDEToolkitIntelliJ']" priority="1"><xsl:text>Amazon Web Services Toolkit for IntelliJ</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JBIDEToolkitPyCharm']" priority="1"><xsl:text>Amazon Web Services Toolkit for PyCharm</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='JBToolkitMarketName']" priority="1"><xsl:text>Amazon Web Services Toolkit</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='MKT']" priority="1"><xsl:text>Amazon Web Services Marketplace</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MKTlong']" priority="1"><xsl:text>Amazon Web Services Marketplace</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MMPlong']" priority="1"><xsl:text>Amazon Web Services Marketplace Management Portal</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='MSExtractlong']" priority="1"><xsl:text>Microservice Extractor for .NET</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='OPSStack']" priority="1"><xsl:text>Amazon Web Services OpsWorks Stacks</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PCAshort']" priority="1"><xsl:text>ACM Private CA</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='PClong']" priority="1"><xsl:text>Amazon Web Services Promotional Credit</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='PLlong']" priority="1"><xsl:text>Amazon Web Services Price List</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='privatelink']" priority="1"><xsl:text>Amazon Web Services PrivateLink</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='REPOST']" priority="1"><xsl:text>re:Post</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='SDKCodeSampCat']" priority="1"><xsl:text>Amazon Web Services Code Sample Catalog</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='Swiftlong']" priority="1"><xsl:text>SDK for Swift</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Snowball']" priority="1"><xsl:text>Snowball</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Snowballlong']" priority="1"><xsl:text>Snowball</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='Snowconsole']" priority="1"><xsl:text>Amazon Web Services Snow Family Management Console</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='SnowDeviceslong']" priority="1"><xsl:text>Snow Family devices</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SnowFamily']" priority="1"><xsl:text>Snow Family</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SnowFamilylong']" priority="1"><xsl:text>Snow Family</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='STSshort']" priority="1"><xsl:text>Amazon Web Services STS</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='SvrlessAppTitle']" priority="1"><xsl:text>Amazon Web Services Serverless Application</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='TFW']" priority="1"><xsl:text>Amazon Web Services Tools for Windows</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='VSCTKMarketName']" priority="1"><xsl:text>Amazon Web Services Toolkit for Visual Studio Code</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAFclassic']" priority="1"><xsl:text>WAF Classic</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='WAFClassicRegional']" priority="1"><xsl:text>WAF Classic Regional</xsl:text></xsl:template>
  ...
  <xsl:template match="*[name()='shared' and @id='xray-dotnetsdk']" priority="1"><xsl:text>Amazon Web Services X-Ray SDK for .NET</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='xray-javasdk']" priority="1"><xsl:text>Amazon Web Services X-Ray SDK for Java</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='xray-nodejssdk']" priority="1"><xsl:text>Amazon Web Services X-Ray SDK for Node.js</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='xray-pythonsdk']" priority="1"><xsl:text>Amazon Web Services X-Ray SDK for Python</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='DCA-top-secret']" priority="1"><xsl:text>AWS</xsl:text></xsl:template>
  <xsl:template match="*[name()='shared' and @id='LCK-secret']" priority="1"><xsl:text>AWS</xsl:text></xsl:template>
