...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="text()">
   <xsl:choose>
    ...
    <xsl:otherwise>
        <xsl:choose>
            <xsl:when test="((ancestor::e:li[parent::e:ul | parent::e:ol]
                                            and empty(ancestor::e:li[1]/descendant::e:p intersect ancestor::*))
                                    or parent::e:section or parent::e:span/parent::e:section
    ...
    <xsl:template name="insertParaInSection">
        ...
        <xsl:choose>
            <xsl:when test="parent::e:section or parent::*[e:br] 
                  or (ancestor::e:li[parent::e:ul|parent::e:ol] 
                        and empty(ancestor::e:li[1]/descendant::e:p intersect ancestor::*))">
